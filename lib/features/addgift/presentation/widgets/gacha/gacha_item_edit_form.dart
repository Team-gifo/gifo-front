                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            TextFormField(
                              ...
                              decoration:
                                  EditFormStyles.inputDecorationWithValidation(
                                    hint: '제목을 입력해주세요',
                                    ...
                                    errorText: !isTitleValid
                                        ...
                                        : null,
                                    suffixIcon:
                                        currentItemData.itemName.isNotEmpty
                                        ? IconButton(
                                            icon: const Icon(
                                              Icons.clear,
                                              size: 20,
                            ...
                            if (currentItemData.imageFile == null)
                              ...
                              EditFormStyles.imagePreviewWithActions(
                                ...
                                onDelete: () {
                                  context.read<GachaSettingBloc>().add(
                                    RemoveGachaItemImage(currentItemData.id),
                                  );
                                },
                              ),
                            const SizedBox(height: 24),
                              ...
                              decoration:
                                  EditFormStyles.inputDecorationWithValidation(
                                    ...
                                    errorText: !isPercentValid
                                        ...
                                        : null,
                                    suffixIcon:
                                        currentItemData.percentStr.isNotEmpty
                                        ? IconButton(
                                            icon: const Icon(
                                              Icons.clear,
                                              size: 20,
