...
$BgmPresetCopyWith<BgmPreset> get copyWith => _$BgmPresetCopyWithImpl<BgmPreset>(this as BgmPreset, _$identity);
  ...
  /// Serializes this BgmPreset to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BgmPreset&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url));
}
...
@override
String toString() {
  return 'BgmPreset(id: $id, name: $name, url: $url)';
}
...
class _BgmPreset implements BgmPreset {
  const _BgmPreset({required this.id, required this.name, this.url = ''});
  factory _BgmPreset.fromJson(Map<String, dynamic> json) => _$BgmPresetFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$BgmPresetToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BgmPreset&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url));
}
