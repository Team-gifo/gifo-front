...
- **Play Contents (경험 중심)**: 가챠, 퀴즈, 언박싱 등 수신자가 즐길 수 있는 인터랙티브 콘텐츠 제공
- **Gift Coupon & Share (소유 및 확산)**:
  - 당첨된 결과는 클립보드 공유 및 기프티콘 이미지(PNG) 발급을 통해 간직 가능
  - 특별한 날의 추억을 시각화하여 소중한 사람에게 영원히 기억될 선물 경험을 선사
